...
| `sistema/05-temas.md` | Sistema de temas (D-289): paquete instalable de fuentes+íconos+paleta en runtime, submenú "Estilo", fallback obligatorio al default | 🟢 Definido 2026-08-17 |
