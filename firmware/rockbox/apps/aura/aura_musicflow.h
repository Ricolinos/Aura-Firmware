 ...
 *
 ****************************************************************************/
/* Music Flow: pantalla propia con su propia entrada de menu
 * (AURA_SCREEN_MUSIC_FLOW, is_musicflow_screen() en aura_screens.c)
 ...
 * proyecto). */
#define AURA_MUSICFLOW_BACK_SIZE 200
#define AURA_MUSICFLOW_BACK_X ((A26_SCREEN_WIDTH - AURA_MUSICFLOW_BACK_SIZE) / 2)
#define AURA_MUSICFLOW_BACK_Y (A26_LAYOUT_STATUSBAR_HEIGHT         + (A26_SCREEN_HEIGHT - A26_LAYOUT_STATUSBAR_HEIGHT - AURA_MUSICFLOW_BACK_SIZE) / 2)
